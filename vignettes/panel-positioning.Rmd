...
```{r, panel1.3_3}
(figure %<>% add_panel(rect_grob(), row = 1:3, column = 3))
```
...
```{r, panel2.3_2.3}
(figure %<>% add_panel(rect_grob(), column = 2:3, row = 3))
```
...
(figure %<>% add_panel(rect_grob(), column = 2:3, row = 3, allow_panel_overwriting = TRUE))
```
